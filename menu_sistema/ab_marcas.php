    ...
    <div class="contenedor">
        ...
        <h1 style="color: #00047F">Agregar marca</h1>
            <form method="POST" action="../Config/alta_sistema.php"><center>
                ...
                <input type="text" name="nf" class="boxtext" placeholder="Nombre marca (Samsung, Xiaomi...)" required><br><br>
        ...
        <h1 style="color: #00047F">Eliminar marca</h1>
            <form method="POST" action="../Config/baja_sistema.php"><center>
                ...
                if ($res->rowCount() > 0){
                    echo "<select type='text' name='nf' class='boxtext' placeholder='Elige marca' class='select-css'>";
                    ?>
