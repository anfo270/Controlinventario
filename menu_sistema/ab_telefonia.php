...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="formSistema">
        <h1 style="color: #00047F">Eliminar tipo de telefonía</h1>
            <form method="POST" action="../Config/baja_sistema.php"><center>
                <input name="tipoAB" value="24jlbn6hk" hidden>
                <?php
                $res = consulta($conexion,"telefonia");

                if ($res->rowCount() > 0){
                    echo "<select type='text' name='nf' class='boxtext' placeholder='Elige tipo de telefonía' class='select-css'>";
                    ?>
                    ...
                    echo "<p>No se encontraron tipos de telefonía.</p>";
                }
                ?>
