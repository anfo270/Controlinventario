        ...
        <h1 style="color: #00047F">Eliminar Modelo</h1>
            <form method="POST" action="../Config/baja_sistema.php"><center>
                ...
                if ($res->rowCount() > 0){
                    ...
                    echo "<p>No se encontraron Modelo.</p>";
                }
                ?>
