...
// if($_GET['identificador']==2){
    $actualizar=actualizar($Nombre,$Apellido_Paterno,$Apellido_Materno,$Contraseña,$puesto,$Local,$Usuario,$conexion);
    if($actualizar){
...
function actualizar($Nombre,$Apellidos_Paterno,$Apellido_Materno,$Contraseña,$puesto,$Local,$Usuario,$conexion){
    $res="UPDATE usuarios SET Nombre=$Nombre , Apellido_Paterno=$Apellidos_Paterno, Apellido_Materno=$Apellido_Materno ,  Usuario=$Usuario ,
                              Contraseña=$Contraseña ,  Puesto=$puesto ,  Local=$Local ";
