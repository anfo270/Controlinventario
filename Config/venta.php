...
while($item=$res->fetch(PDO::FETCH_OBJ)){
    $resventas=$conexion->query("INSERT INTO ventas (IMEIICCSKU, Modelo, Marca,Vendedor,Tipo vendedor,Fecha,Locacion,Precio,Financiera) VALUES ('$item->IMEIICCSKU','$item->Modelo','$item->Marca','$nombre','$puesto','$Fecha','$locacion','$item->Precio','$item->FinancieraActivacion')") or die(print_r($conexion->errorInfo()));
